<!-- Main Content -->
<div class="content-transition flex-1 overflow-auto" :class="isCollapsed ? 'ml-20' : 'ml-64'">
    <div class="p-8">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-800 capitalize" x-text="activeMenu"></h1>
            <p class="text-gray-600 mt-2">Selamat datang di Sistem Akademik</p>
        </div>
