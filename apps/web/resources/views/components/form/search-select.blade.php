...
>
    ...
    <div class="relative">
        ...
        {{-- clear button --}}
        <button type="button" x-show="search" x-cloak @click="clear()" class="absolute right-8 top-1/2 -translate-y-1/2 btn btn-ghost btn-xs">
            &times;
        </button>
        ...
        <template x-if="!filtered.length">
            <div class="p-4 text-center text-sm text-gray-500">
                ...
                @if($actionLabel && $actionEvent)
                    <div class="mt-3">
                        <button wire:click="{{ $actionEvent }}" type="button" class="btn btn-primary btn-sm">
                            {{ $actionLabel }}
                        </button>
                    </div>
                @endif
