...
class StudyProgramService
{
    ...
    public function create(?int $head_id = null, int $department_id, array $data): StudyProgram
    {
    ...
    public function update(StudyProgram $studyProgram, ?int $head_id = null, int $department_id, array $data): StudyProgram
    {
